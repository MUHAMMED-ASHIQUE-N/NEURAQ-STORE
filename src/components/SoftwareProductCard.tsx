...
export default function SoftwareProductCard({
  ...
  return (
    <div
      className={`w-full sm:w-72 h-72 bg-white rounded-xl border shadow transition-all duration-300
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 mb-2">
        <button
          className="flex items-center gap-1 rounded-lg bg-gradient-to-r from-indigo-400 via-blue-500 to-cyan-400 text-white px-3 py-1 font-semibold shadow hover:from-indigo-500 hover:to-cyan-500 transition"
        ...
        <button
          className="flex items-center gap-1 rounded-lg bg-gradient-to-r from-red-500 via-pink-400 to-indigo-300 text-white px-3 py-1 font-semibold shadow hover:from-red-600 hover:to-indigo-400 transition"
        ...
        <button
          className="flex items-center gap-1 rounded-lg bg-gradient-to-r from-gray-500 to-gray-700 text-white px-3 py-1 font-semibold shadow hover:from-gray-700 hover:to-gray-900 transition"
