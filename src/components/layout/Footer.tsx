  ...
  return (
    <footer className="mt-16 border-t bg-white/60 dark:bg-background/70">
      <div className="container grid gap-10 py-12 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 font-extrabold tracking-tight">
            ...
            <span className="text-xl">Neuraq Store</span>
          </div>
          <p className="mt-4 text-sm text-muted-foreground max-w-xs">
            Premium e-commerce experience with stunning design and blazing-fast
            performance.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <form className="mt-3 flex gap-2">
            <input
              ...
              className="h-10 flex-1 rounded-md border bg-background px-3 text-sm outline-none ring-0 focus:border-primary"
            />
      ...
      <div className="border-t py-6 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} Neuraq Store. All rights reserved.
      </div>
    </footer>
  );
}
